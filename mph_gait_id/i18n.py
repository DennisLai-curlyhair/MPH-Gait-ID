...
MESSAGES: dict[str, dict[str, str]] = {
    "workflow.review_title": {"zh_TW": "註冊儲存前檢視：{name}", "en": "Review before Gallery commit: {name}"},
    "workflow.review_note": {
        "zh_TW": "自動移動方向僅供診斷；請確認人物行走時面向相機，並選取要儲存的片段。",
        "en": "Choose which captured passes to include. Automatic movement direction is diagnostic only; front-facing orientation must be controlled by the operator.",
    },
    "workflow.review_heading": {"zh_TW": "擷取方向／觀察移動", "en": "Capture type / observed movement"},
    "workflow.recommended": {"zh_TW": "建議納入", "en": "recommended"},
    "workflow.no_pass": {"zh_TW": "沒有擷取到片段。", "en": "No pass was captured."},
    "workflow.readiness": {"zh_TW": "啟動前檢查", "en": "Readiness"},
    "workflow.source": {"zh_TW": "來源", "en": "Source"},
    "workflow.model": {"zh_TW": "模型／權重", "en": "Model / checkpoint"},
    "workflow.detector": {"zh_TW": "人物偵測器", "en": "Person detector"},
    "workflow.gallery": {"zh_TW": "相容 Gallery", "en": "Compatible Gallery"},
    "workflow.identity": {"zh_TW": "註冊人物", "en": "Enrollment identity"},
    "workflow.settings": {"zh_TW": "設定", "en": "Settings"},
    "workflow.ready": {"zh_TW": "已就緒", "en": "Ready"},
    "workflow.not_checked": {"zh_TW": "啟動時於背景驗證裝置", "en": "Device verified in background on start"},
    "workflow.model_pending": {"zh_TW": "權重檔案存在；啟動時載入驗證", "en": "Checkpoint found; load verified on start"},
    "workflow.model_missing": {"zh_TW": "未選模型或權重檔案不存在", "en": "No model selected or checkpoint missing"},
    "workflow.source_missing": {"zh_TW": "未找到 Replay 資料夾", "en": "Replay folder not found"},
    "workflow.detector_pending": {"zh_TW": "設定有效；啟動時載入（可能下載）", "en": "Configured; loads on start (may download)"},
    "workflow.gallery_count": {"zh_TW": "{persons} 人／{count} 個特徵，T={length}", "en": "{persons} people / {count} embeddings, T={length}"},
    "workflow.gallery_optional": {"zh_TW": "註冊不需要既有 Gallery", "en": "Existing Gallery not required for enrollment"},
    "workflow.identity_missing": {"zh_TW": "請填寫人物 ID 與名稱", "en": "Person ID and name required"},
    "workflow.identity_conflict": {"zh_TW": "此 ID 已登記為 {name}", "en": "This ID is registered as {name}"},
    "workflow.not_required": {"zh_TW": "不適用", "en": "Not required"},
    "workflow.invalid_settings": {"zh_TW": "請確認影格、步幅與註冊數值設定", "en": "Check frame, stride and enrollment settings"},
    "workflow.busy": {"zh_TW": "目前有工作執行中", "en": "Operation in progress"},
    "workflow.starting": {"zh_TW": "正在開啟來源", "en": "Opening source"},
    "workflow.starting.detail": {"zh_TW": "正在背景檢查來源與裝置", "en": "Checking source and device in the background"},
    "workflow.source_ready": {"zh_TW": "來源已開啟，正在載入模型", "en": "Source opened; loading models"},
    "workflow.source_ready.detail": {"zh_TW": "正在載入人物偵測器與步態模型", "en": "Loading person detector and gait model"},
    "workflow.waiting_person": {"zh_TW": "等待人物", "en": "Waiting for a person"},
    "workflow.waiting_person.detail": {"zh_TW": "目前沒有偵測到人物，未產生新辨識結果", "en": "No person detected; no new identification result"},
    "workflow.multiple_people": {"zh_TW": "嚴格模式：偵測到多位人物", "en": "Strict mode: multiple people detected"},
    "workflow.multiple_people.detail": {"zh_TW": "本次設定只接受單一人物，暫停收集", "en": "Current settings require one person; collection paused"},
    "workflow.insufficient_points": {"zh_TW": "有效人體點數不足", "en": "Insufficient foreground points"},
    "workflow.insufficient_points.detail": {"zh_TW": "本幀未通過前處理檢查，未產生新辨識結果", "en": "Frame failed preprocessing checks; no new identification result"},
    "workflow.collecting": {"zh_TW": "累積有效影格", "en": "Collecting valid frames"},
    "workflow.collecting.detail": {"zh_TW": "影格緩衝 {frames}/{total}；依設定步幅進行推論", "en": "Frame buffer {frames}/{total}; inference follows the configured stride"},
    "workflow.complete": {"zh_TW": "播放完成", "en": "Replay complete"},
    "workflow.complete.detail": {"zh_TW": "來源已結束，可再次啟動", "en": "Source ended; a new run can be started"},
    "workflow.error": {"zh_TW": "執行失敗", "en": "Operation failed"},
    "workflow.no_gallery": {"zh_TW": "沒有相容的 Gallery", "en": "No compatible Gallery"},
    "workflow.no_gallery.detail": {"zh_TW": "目前模型／權重與 T 沒有可用特徵；請先註冊、重編碼或匯入相容 Gallery", "en": "No usable embeddings for this model/checkpoint and T; enroll, re-encode or import a compatible Gallery"},
    "workflow.pending": {"zh_TW": "等待穩定：{name}", "en": "Awaiting stability: {name}"},
    "workflow.unknown": {"zh_TW": "未知人物（候選：{name}）", "en": "Unknown (candidate: {name})"},
    "workflow.scores": {"zh_TW": "相似度 {score:.3f}｜分差 {margin:.3f}｜穩定窗口 {count}/{total}", "en": "Similarity {score:.3f} | Margin {margin:.3f} | Stable windows {count}/{total}"},
    "workflow.enrollment_paused": {"zh_TW": "註冊已準備：{name}", "en": "Enrollment ready: {name}"},
    "workflow.enrollment_paused.detail": {"zh_TW": "可開始下一片段；Gallery 尚未更新", "en": "Ready for the next pass; Gallery not yet updated"},
    "workflow.enrollment_countdown": {"zh_TW": "行走前準備：{name}", "en": "Prepare to walk: {name}"},
    "workflow.enrollment_countdown.detail": {"zh_TW": "有效人物暖機倒數 {seconds:.1f} 秒；尚未開始擷取", "en": "Valid-person warm-up: {seconds:.1f} s remaining; capture not yet started"},
    "workflow.enrolling": {"zh_TW": "正在擷取：{name}", "en": "Capturing: {name}"},
    "workflow.enrolling.detail": {"zh_TW": "累積 {count} 個特徵／最低 {minimum}；尚未存入 Gallery", "en": "{count} embeddings / minimum {minimum}; not yet saved to Gallery"},
    "workflow.enrollment_review": {"zh_TW": "待檢視片段：{name}", "en": "Review passes: {name}"},
    "workflow.enrollment_review.detail": {"zh_TW": "可用片段 {passes}／特徵 {count}；確認儲存後才更新 Gallery", "en": "{passes} usable passes / {count} embeddings; Gallery updates only on commit"},
    "workflow.enrollment_failed": {"zh_TW": "註冊未儲存", "en": "Enrollment not saved"},
    "workflow.enrolled": {"zh_TW": "註冊完成：{name}", "en": "Enrollment complete: {name}"},
    "workflow.enrolled.detail": {"zh_TW": "已儲存 {stored} 個特徵", "en": "Saved {stored} embeddings"},
    "workflow.stage.prepare": {"zh_TW": "1. 準備", "en": "1. Prepare"},
    "workflow.stage.capture": {"zh_TW": "2. 擷取", "en": "2. Capture"},
    "workflow.stage.review": {"zh_TW": "3. 檢視", "en": "3. Review"},
    "workflow.stage.save": {"zh_TW": "4. 儲存", "en": "4. Save"},
    "workflow.request.start": {"zh_TW": "已送出開始要求，等待人物與暖機", "en": "Start requested; waiting for person and warm-up"},
    "workflow.request.end": {"zh_TW": "正在結束片段，等待擷取工作回覆", "en": "Ending pass; awaiting capture worker"},
    "workflow.request.finish": {"zh_TW": "正在結束擷取並準備檢視", "en": "Finishing capture and preparing review"},
    "workflow.stopping": {"zh_TW": "正在停止並釋放裝置", "en": "Stopping and releasing device"},
    "workflow.stopped": {"zh_TW": "已停止", "en": "Stopped"},
    "workflow.select_pass": {"zh_TW": "請至少選取一個可註冊片段", "en": "Select at least one usable pass"},
    "workflow.review_selection": {"zh_TW": "已選 {passes} 個片段／{count} 個候選特徵", "en": "Selected: {passes} passes / {count} candidate embeddings"},
